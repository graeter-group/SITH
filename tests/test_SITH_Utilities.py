...
testPath = pathlib.Path("/hits/fast/mbm/farrugma/sw/SITH/tests/test-methanol.fchk")
...
def test_extractedGeometry():
    ...
    egeo.buildRIC(dimsGoodInput, dimIndicesGoodInput, coordLinesGoodInput)
    assert extractor.geometry == egeo
